...
\blocksvg{enc-osc}{.62}{Plot of Oscillator frequency vs supply voltage for HT12E}
\vspace*{20pt}
\blocksvg{dec-osc}{.62}{Plot of Oscillator frequency vs supply voltage for HT12D}

\subsection{Switching circuit}


\blocksvg{switch}{.35}{Switching circuit}
% \begin{figure}[ht!]
% 	\centering
...
\blocksvg{bc547}{.65}{Plot of CE voltage vs collector current for BC547}
