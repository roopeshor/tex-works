...
\begin{center}
	\fontsize{16}{16}
	\selectfont
	\textbf{Experiment 1 : Study Of Microwave Components}
\end{center}
...
waves leaving the two side arms have equal magnitudes and are in phase.
...
\subsection{Frequency Meter (Resonant Type)}
...
\subsection{Klystron Power Supply}
