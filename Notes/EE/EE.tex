...
\subtopic{Voltage Source in series}
...
\ssubsection{Voltage Divider Rule (VDR)}
...
\ssubsection{Current divider rule}
...
\subtopic{Maxwell's Loup Current Method}
...
\subtopic{Star Deltra transformation}
\begin{figure}[h]
