...
\chapterheader{3}{Superconductivity \& Nanomaterials}
\vspace{1cm}
\noparindent

\ssubsection{\texorpdfstring{Resistivity $(\rho)$ \& conductivity $(\sigma)$}{Resistivity \& conductivity}}
...
\subtopic{Classification of superconductors}
...
\qa{1}{Calculate critical current for a wire of lead Having a diameter 1 mm of at 4.2 K, T$_c$ for lead is 7.18K, $H_c(0)=6.5 \times 10^4 \uunit{A/m}$}{
	$$
		\begin{aligned}
...
\topic{Smart materials}
\subtopic{Liquid Crystal}
