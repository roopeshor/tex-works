...
\chapterheader{2}{Crystallography}
...
\input{../images/lattice-basis-crystal.tex}

\multiskip{3}

\begin{minipage}[t][][b]{.6\textwidth}
	\ssubsection{Unit cell}
...
\topic{Bragg's X-ray spectrometer}

\fullwidthimg{braggs}

\ssubsection{Components}
\begin{itemize}
