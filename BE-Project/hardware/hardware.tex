...
\pgfdeclareshape{arduino}{%
	...
	\foregroundpath{
		...
		\pinlabel{\textmargin}{2cm}{\fixedsm $\sim$D11}
		\pinlabel{\textmargin}{1.5cm}{\fixedsm $\sim$D10}
		\pinlabel{\textmargin}{1cm}{\fixedsm $\sim$D9}
		\pinlabel{\textmargin}{.5cm}{D8}
		\pinlabel{\textmargin}{0cm}{D7}
		\pinlabel{\textmargin}{-.5cm}{\fixedsm $\sim$D6}
		\pinlabel{\textmargin}{-1cm}{\fixedsm $\sim$D5}
		\pinlabel{\textmargin}{-1.5cm}{D4}
		\pinlabel{\textmargin}{-2cm}{\fixedsm $\sim$D3}
