...
\hypersetup{
    ...
    pdfauthor={Roopesh},
    pdfdisplaydoctitle=true  % Forces viewer to show title, not filename
}
\begin{center}
...
When state $G$ has reached, the vending machine dispenses. From $G$ the state transition scheme is as following: if input is 5, it goes to $B$ or if input is $10$ it goes to $C$.
...
\begin{tcolorbox}
  ...
  (\href{https://gemini.google.com/share/da168e616523}{Why?})
  ...
  Hence additional state has to be added.
\end{tcolorbox}
...
\begin{center}
  ...
  \vspace{1em}
  $S_1' = \scb(\textcolor{red}{S_0\xab} + \textcolor{blue}{S_1} + \textcolor{green!60!black}{X_2}) + S_2(\textcolor{orange}{\sab\xab\xbb} + \textcolor{green!60!black}{S_1X_1} + \textcolor{blue}{S_1X_2})$
\end{center}
\vspace{1em}
...
\begin{center}
  ...
  \vspace{1em}
  $S_0' = \scb(\textcolor{red}{S_0\xab} + \textcolor{blue}{\sbb X_1}) + S_2(\textcolor{red}{S_0\xbb} + \textcolor{green!60!black}{S_1X_1} + \textcolor{orange}{S_1X_2})$
\end{center}
